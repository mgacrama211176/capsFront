        ...
        <Typography variant="caption" component="h6">
          <List>
            ...
            >
              ...
              <Typography variant="caption">
                • Uploading harmful or dangerous content
              </Typography>
              <Typography variant="caption">
              ...
              <Typography variant="caption">• Hate speech</Typography>
              <Typography variant="caption">
          ...
          <Typography variant="body2" component="h6">
            ...
            to, for accuracy, legality, or noninfringement, and we are not
          ...
          <Typography variant="body2" component="h6">
            ...
            Websites or any ThirdParty Content does not imply approval or
          ...
          <Typography variant="body2" component="h6">
            ...
            Policy: __________. By using the Site, you agree to be bound by our
            Privacy Policy, which is incorporated into these Terms of Use.
            Please be advised the Site is hosted in the Philippines. If you
            ...
            disclosure that differ from applicable laws in the Philippines, then
            through your continued use of the Site, you are transferring your
            data to the Philippines, and you agree to have your data transferred
            to and processed in the Philippines. Further, we do not knowingly
          ...
          <Typography variant="body2" component="h6">
            ...
            the Philippines. FilAnime and yourself irrevocably consent that the
            courts of the Philippines shall have exclusive jurisdiction to
          ...
          <Typography variant="body2" component="h6">
            ...
            arbitration shall be Cebu City, Philippines. The language of the
            proceedings shall be English, Filipino. The governing law of the
            contract shall be the substantive law of the Philippines.
          </Typography>
          <br />
          <Typography variant="h6" component="h2">
            Restrictions
